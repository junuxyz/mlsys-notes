...
This note documents the recovery procedure used when NCCL could see NVLink SHARP (NVLS), but could not allocate its multicast resources on H100 NVSwitch node.
